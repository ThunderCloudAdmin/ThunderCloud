...
namespace ThunderServer.Infrastructure.Migrations
{
    ...
    [Migration("20240910093303_addedSupportForEncryptedRsaKeyForUser")]
    partial class addedSupportForEncryptedRsaKeyForUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThunderServer.Models.Argon2Key", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Argon2Key", (string)null);
                });
            ...
            modelBuilder.Entity("ThunderServer.Models.RsaKeyPairServer", b =>
                {
                    ...
                    b.Property<byte[]>("EncryptedPrivateRsaKey")
                        .IsRequired()
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("ThunderServer.Models.RsaKeyPairServer", b =>
                {
                    b.HasOne("ThunderServer.Models.Argon2Key", "Argon2Key")
                        .WithOne("RsaKeyPairServer")
                        .HasForeignKey("ThunderServer.Models.RsaKeyPairServer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
