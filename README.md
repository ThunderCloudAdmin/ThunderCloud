...
<ol>
  <li>Secure</li>
  <ol>
    <li>End2End Encryption of data from clients to server so that even the server owner can't access your files</li>
  </ol>
  <li>Reliable</li>
  <ol>
...
## Development Mode
<ol>Steps to setup Serer development
  <li>Add WSL2 to your computer</li>
  <li>Set the variable under Storage-Volumes.UploadFolder so that it will be created with the first run</li>
  <li>Run docker compose so that the database is created<li>
