...
public class ThunderFile
{
    ...
    public Guid UserId { get; set; } // Reference to the owner of the file (UserId from Identity)
    public string FileName { get; set; } // Name of the file
    public string FileType { get; private set; }
    public long FileSize { get; set; } // Size of the file in bytes
    public string MimeType { get; set; } // File type (e.g., application/pdf)
    public string FilePath { get; set; } // Path to the encrypted file on the server
    public Guid OwnerId { get; private set; }
    public byte[] EncryptedFileKey { get; set; } // AES key encrypted with the user's public key
    ...
    public bool IsShared { get; set; } // Indicates whether the file is shared
